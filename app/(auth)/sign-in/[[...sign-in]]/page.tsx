...
export default function Page() {
  return (
    <div className="relative min-h-screen flex flex-col md:grid md:grid-cols-2">
      ...
      <div className="absolute inset-0 bg-cover bg-center md:hidden" style={{ backgroundImage: `url('/login.png')` }}>
      ...
      <div className="relative z-10 flex justify-center items-center h-screen md:h-auto">
        <div className="w-full max-w-sm"> {/* You can style the wrapper div instead */}
          <SignIn />
        </div>
      </div>
    </div>
